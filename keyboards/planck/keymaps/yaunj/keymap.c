 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |Numpad| Menu | GUI  | Alt  |Lower |    Space    |Raise | Ralt | RGUI | Menu |Numpad|
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC,
    CTL_ESC, Q_M_A,   Q_M_S,   Q_M_D,   Q_M_F,   KC_G,    KC_H,    Q_M_J,   Q_M_K,   Q_M_L,   Q_M_SC,  KC_QUOT,
    CADET_L, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, CADET_R,
    NUMPAD,  KC_APP,  KC_LGUI, KC_LALT, LOWER,  SPACEFN, SPACEFN,  RAISE,   KC_RALT, KC_RGUI, KC_APP,  NUMPAD
),
...
[_NUMPAD] = LAYOUT_planck_grid(
    _______, KC_HOME, KC_UP,   KC_END,  _______, _______, _______, KC_7,    KC_8,    KC_9,    KC_MINS, _______,
    ...
    _______, _______, _______, _______, _______, _______, _______, KC_0,    KC_DOT,  KC_DOT,  XXXXXXX, _______
),
