...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    XXXXXXX, KC_APP,  KC_LGUI, KC_LALT, LOWER,  SPACEFN, SPACEFN,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_RAISE] = LAYOUT_planck_grid(
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F12,  XXXXXXX, XXXXXXX, KC_SLSH,  KC_7,    KC_8,    KC_9,   KC_BSPC,
    _______, KC_F4,   KC_F5,   KC_F6,   KC_F11,  XXXXXXX, XXXXXXX, KC_MINS,  KC_4,    KC_5,    KC_6,   KC_PLUS,
    _______, KC_F1,   KC_F2,   KC_F3,   KC_F10,  XXXXXXX, XXXXXXX, KC_COMM,  KC_1,    KC_2,    KC_3,   _______,
    _______, _______, _______, _______, _______, _______, _______, _______,  KC_0,  KC_DOT, _______,   _______
),

[_NAV] = LAYOUT_planck_grid(
    _______, KC_PGUP, KC_UP,   KC_PGDN, XXXXXXX, XXXXXXX, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  XXXXXXX, _______,
    _______, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, XXXXXXX, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX, _______,
    _______, XXXXXXX, XXXXXXX, CTL_INS, SFT_INS, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
